...
public class PhysicsUtil
{
        ...
        out List<RaycastHit> hits, float distance, LayerMask layerMask, bool debugDraw = false)
    {
        ...
        bool leftHitFound = Physics.Raycast(origin - transform.right * spacing, Vector3.down, out RaycastHit leftHit, distance, layerMask);
        bool rightHitFound = Physics.Raycast(origin + transform.right * spacing, Vector3.down, out RaycastHit rightHit, distance, layerMask);
